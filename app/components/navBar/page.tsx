...
export default function Navbar() {
  return (
   <nav className="fixed top-0 w-full flex flex-nowrap justify-end items-center gap-8 p-4 bg-white/30 backdrop-blur-md border-b border-white/20 z-50 overflow-x-auto">
